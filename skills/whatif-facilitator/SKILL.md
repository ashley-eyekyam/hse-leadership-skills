---
name: whatif-facilitator
description: 'Structures a disciplined What-If question-set workshop and records the
  team''s responses and actions: What-If question, hazard/consequence, existing safeguards,
  risk rank, and recommendations tracked to closure. Assistive: it structures the
  question set and records the team''s analysis, never inventing a consequence or
  fabricating a risk rank, recording [GAP] instead. Decision-support only; a competent
...
An **assistive** (Tier-4) skill that structures a disciplined What-If question-set workshop and records the team's responses and actions. It builds the systematic What-If question set for the named scope, captures each What-If → hazard/consequence → existing-safeguard → recommendation as the team supplies it, risk-ranks each line with `risk_matrix`, HoC-ranks safeguards with `controls`, and tracks recommendations with `smart_actions`. It **never invents a consequence** the team did not raise and records `[GAP]` rather than a fabricated risk rank.

## When to use this skill

Use this skill to facilitate or write up a What-If analysis for a **named process / operation** — e.g. "run a What-If on the loading procedure", "structure our What-If question set for the start-up sequence". It is the question-set discipline (systematic 'What if …?' prompts), lighter than a full HAZOP, suitable for procedures and simpler systems. The team supplies the answers; if the request is vague, the intake forces the specific scope and the team first.
...
| Process (any) | ../../knowledge-base/standards/iec-61882.md (KB-STD-IEC-61882 — the structured-study discipline What-If shares) |
