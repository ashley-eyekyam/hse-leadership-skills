---
name: tank-farm-bunding-controls
description: Assess bulk-storage, tank-farm and bunding controls — secondary containment
  sizing basis, segregation of incompatible substances, overfill protection, drainage
  and firewater containment. Use it to assess a tank farm, size a bund, plan secondary
  containment, or review overfill / segregation controls for bulk chemical storage.
  Containment basis and controls are hierarchy-of-controls ranked and traced to evidence
  with named owners and dates; flammable-atmosphere area control grounds in DSEAR;
  India storage licensing pointers reference PESO. Decision-support only; a competent
...
A consultant-grade skill that assesses bulk-storage / tank-farm / bunding controls — secondary containment sizing basis, segregation of incompatible substances, overfill protection, drainage and firewater containment. It states the containment basis (e.g. 110% of the largest tank or the applicable local rule — resolved, not assumed), bands consequence with `risk_matrix`, HoC-ranks controls with `controls`, and validates remediation with `smart_actions`. Flammable-atmosphere area control grounds in `KB-STD-DSEAR`; India storage licensing pointers reference `KB-REG-IN-PESO` (hse-process-owned).

## When to use this skill

Use this skill to assess a tank farm, size a bund, plan secondary containment, or review overfill/segregation controls for bulk chemical storage — for named stored substances, volumes and a storage configuration. If the request is vague, the intake forces the substances, volumes and configuration first.
...
| Jurisdiction | Read |
|---|---|
| UK/EU | ../../knowledge-base/standards/dsear-atex.md (KB-STD-DSEAR flammable-atmosphere area control) |
| India | ../../knowledge-base/regulatory/in-peso.md (KB-REG-IN-PESO storage licensing) + in-state-forms.md (mandatory state detection) |
| Any   | ../../knowledge-base/standards/iso-45001.md (6.1.2) + standards/dsear-atex.md + prompt-snippets/hierarchy-of-controls.md (KB-SNIP-HOC) |
