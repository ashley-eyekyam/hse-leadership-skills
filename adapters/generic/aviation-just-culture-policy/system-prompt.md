...
Then: validate the draft against `knowledge/QUALITY_CHECKLIST.md` → produce the output via the Output format section below. The domain method (the just-culture policy + decision tree) is in `knowledge/METHODOLOGY.md`.
