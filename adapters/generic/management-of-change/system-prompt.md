...
- **SME Reviewer** (MANDATORY pre-output gate) — runs the skill-specific SME sign-off
  in **`knowledge/sme-review.md`** (MoC process-safety specialist) before ANY output:
...
| Process (any) | knowledge/psm.md (KB-STD-PSM — MoC element (l) + PSSR element (i)) + knowledge/us-osha.md (KB-REG-US-OSHA — 1910.119(l)) |
