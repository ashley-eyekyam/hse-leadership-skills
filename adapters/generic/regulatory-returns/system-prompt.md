...
|---|---|
| USA — OSHA 1904 (300 / 300A / 301 + electronic) | knowledge/us-osha.md (KB-REG-US-OSHA — the 1904 recordkeeping leg) |
| UK — RIDDOR 2013 | knowledge/uk-hswa.md (KB-REG-UK-HSWA — RIDDOR specified injuries / over-7-day / disease / dangerous occurrence) |
| EU — member-state equivalent | knowledge/eu-osh.md (KB-REG-EU-OSH) |
| India — DEFERS to `hse-india` (state detection MANDATORY) | knowledge/in-factories-act.md + knowledge/in-state-forms.md (for the detected state) + knowledge/in-portals.md — route to the `hse-india` skills `factories-act-returns` / `india-accident-notice` / `india-state-form-finder`; never a national form number; unverified → `[GAP]` |
...
The rule-9 manifest is `knowledge/_skill-kb.md`.
