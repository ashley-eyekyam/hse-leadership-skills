...
| Jurisdiction | Read |
|---|---|
| Any (SMS Pillar 2 / MoC) | knowledge/icao-annex19.md (KB-STD-ICAO-ANNEX19 — Pillar 2 Safety Risk Management / management of change) + prompt-snippets/hierarchy-of-controls.md (KB-SNIP-HOC) |
