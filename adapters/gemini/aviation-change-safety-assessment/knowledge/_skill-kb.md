# Knowledge-base manifest for `aviation-change-safety-assessment`
...
| ID | Use | Path |
|---|---|---|
| KB-STD-ICAO-ANNEX19 | Pillar 2 (Safety Risk Management) — the management-of-change grounding. | ../../../knowledge-base/standards/icao-annex19.md |
| KB-DATA-AVI-RISK-MATRIX | The ICAO 5×5 MatrixConfig passed to risk_matrix.score() for the change's hazard ratings. | ../../../knowledge-base/data-points/aviation-risk-matrix.md |
| KB-SNIP-HOC | Rank every change mitigation through the hierarchy of controls (flag PPE/admin-only). | ../../../knowledge-base/prompt-snippets/hierarchy-of-controls.md |
