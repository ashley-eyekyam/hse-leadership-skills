...
| UK    | knowledge/uk-hswa.md (construction → CDM 2015 reg. 13/15 + Construction Phase Plan rows, KB-REG-UK-HSWA) |
...
aspects use `risk-assessment`). The rule-9 manifest is `knowledge/_skill-kb.md`.
