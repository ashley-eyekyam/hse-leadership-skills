...
| Jurisdiction | Read |
|---|---|
| India (mine) | knowledge/in-mines-act.md (KB-REG-IN-MINES-ACT) + regulatory/in-dgms.md (KB-REG-IN-DGMS — forms; [GAP] where unverified) |
| India (region) | knowledge/in-state-forms.md (KB-REG-IN-STATEFORMS — mandatory region/zone resolution) |
| Any | knowledge/iso-45001.md (KB-STD-ISO45001 — MS backbone) + prompt-snippets/hierarchy-of-controls.md (KB-SNIP-HOC) |
