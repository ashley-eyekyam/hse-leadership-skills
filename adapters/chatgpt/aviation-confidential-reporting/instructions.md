...
| Jurisdiction | Read |
|---|---|
| Any (SMS Pillar 4) | knowledge/icao-annex19.md (KB-STD-ICAO-ANNEX19 — Pillar 4 Safety Promotion / confidential reporting) + prompt-snippets/hierarchy-of-controls.md (KB-SNIP-HOC) |
