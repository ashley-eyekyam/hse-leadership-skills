# Knowledge-base manifest for `india-state-form-finder`
...
| KB-REG-IN-OSH-CODE | (author the use) |  |
| KB-REG-IN-PORTALS | (author the use) |  |
| KB-REG-IN-FACTORIES | (author the use) | ../../../knowledge-base/regulatory/in-factories-act.md |
| KB-STD-ISO45001 | (author the use) | ../../../knowledge-base/standards/iso-45001.md |
| KB-SNIP-HOC | (author the use) | ../../../knowledge-base/prompt-snippets/hierarchy-of-controls.md |
