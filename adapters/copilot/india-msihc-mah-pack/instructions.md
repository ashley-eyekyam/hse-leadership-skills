...
| Jurisdiction | Read |
|---|---|
| India | knowledge/in-msihc.md (KB-REG-IN-MSIHC — MAH/emergency plan/safety report) + in-state-forms.md (mandatory state detection) |
| India | knowledge/in-peso.md (KB-REG-IN-PESO — petroleum/explosives/SMPV licensing pointers) + in-factories-act.md |
| Any   | knowledge/iso-45001.md (6.1.2) + prompt-snippets/hierarchy-of-controls.md (KB-SNIP-HOC) |
